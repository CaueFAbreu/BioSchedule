...
- Cargas curriculares e requisitos dos 64 componentes: `fluxogramaeb2020-versao12.pdf`, página única, fornecido pelo usuário. Associação por nome, pois o fluxograma utiliza numeração própria (1–64), não códigos. Todas as disciplinas de extensão (I a V) são online, sem horário fixo, conforme informado pelo usuário. Preservam suas cargas curriculares (90h, 60h, 90h, 60h e 120h), totalizando 420h, sem ocupar blocos da grade semanal.
